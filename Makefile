.PHONY: setup update set_hardware_v1 set_hardware_v2 build flash monitor flash-monitor clean fullclean menuconfig help
...
setup:
	...
	@echo "Installing toolchain (esp32, esp32s3)..."
